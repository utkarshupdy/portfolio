...
const WorkExperience = () => {
  ...
  const workExperiences = [
    {
      ...
      technologies: ["Next.js", "React.js", "Sanity", "AWS", "Tailwind CSS", "API Optimization", "Real-time Data", "Responsive Design", "Caching Strategies"]
    },
    {
      id: 2,
      company: "SendPay",
      ...
      technologies: ["Node.js", "Express.js", "Mongo DB", "Next.js", "React.js", "Tailwind CSS", "Authentication",  "OAuth", "JWT", "Payment Processing", "AI Integration"]
    },
    {
  id: 3,
  ...
  type: "Projects",
  logo: "/project-logo.svg",
  description: "Contributed to open-source projects by developing full-stack AI-powered applications and real-time systems using modern web technologies.",
  achievements: [
    "Built ReelForge AI, a full-stack platform integrating 10+ AI models to convert text prompts into audio/video, reducing content creation time by 40%",
    "Implemented a scalable payment system using Razorpay with real-time transaction handling and API rate limiting, supporting 1,500+ transactions at 99.9% uptime",
    "Engineered LoadShield, an AI-powered theft detection system with YOLOv5 achieving 92% accuracy, and built a live surveillance dashboard with WebSockets and React.js"
  ],
  technologies: ["React.js", "Node.js", "Express.js", "MongoDB", "WebSockets", "Docker", "YOLOv5", "Redis", "Razorpay", "AI/ML"]
}
          ...
          {workExperiences.map((experience) => (
            <div key={experience.id} className="experience-card">
              <div className="card-content">
                ...
                <div className="card-header">
                  <div className="header-main">
                    ...
                    <div className="company-info">
                      <div className="company-title-row">
                        <h3 className="company-name">{experience.company}</h3>
                        <span className={`type-badge ${experience.type.toLowerCase()}`}>
                          {experience.type}
                        </span>
                      </div>
                      <h4 className="position-title">{experience.position}</h4>
                ...
                >
                  <span>
                    {expandedCard === experience.id ? 'Hide Achievements' : 'View Key Achievements'}
                  </span>
                  {expandedCard === experience.id ? 
                    <ChevronUp size={20} /> : 
                    <ChevronDown size={20} />
